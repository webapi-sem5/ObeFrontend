...
function AssignThreshold(props) {
  ...
  const handleSubmit = (event) => {
    ...
    axios.post("https://obesystemtesting.azurewebsites.net/api/threshold", data).then((res) => {
      console.log(res);
    ...
    axios.put(`https://obesystemtesting.azurewebsites.net/api/module/${ModuleId}`, dataId);
  };
